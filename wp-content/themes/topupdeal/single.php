		...
		<div id="content" class="site-content" role="main"> -->
			...
			<?php
                ...
                <section class="about-section">
                    <div class="container">
                        <h2 class="title mb-lg-9">About Mero Marketing Store</h2>
                        <div class="row mb-10">
                            <div class="col-md-6">
                                <img class="w-100 mb-4 appear-animate"
                                    data-animation-options="{'name':'fadeInLeftShorter'}"
                                    src="<?php echo get_template_directory_uri() ?>/images/subpages/about.jpg" alt="Mero Marketing Store" width="587" height="517"
                        ...
                        <div class="owl-carousel owl-shadow-carousel owl-same-height owl-theme row cols-lg-3 cols-sm-2 cols-1 pb-4"
                            ...
                            <div class="testimonial testimonial-centered bg-white">
                                <div class="testimonial-info">
                                    ...
                                    <figure class="testimonial-author-thumbnail">
                                        <img src="<?php echo get_template_directory_uri() ?>/images/subpages/reviewer-1.png" alt="user" width="70" height="70" />
                                    </figure>
                            ...
                            <div class="testimonial testimonial-centered bg-white">
                                <div class="testimonial-info">
                                    ...
                                    <figure class="testimonial-author-thumbnail">
                                        <img src="<?php echo get_template_directory_uri() ?>/images/subpages/reviewer-2.png" alt="user" width="70" height="70" />
                                    </figure>
                                    <blockquote>“ Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Phasellus
                                        hendrerit. Pellentesque aliquet nibh nec urna. In nisi neque ”</blockquote>
                                    <cite>
                            ...
                            <div class="testimonial testimonial-centered bg-white">
                                <div class="testimonial-info">
                                    ...
                                    <figure class="testimonial-author-thumbnail">
                                        <img src="<?php echo get_template_directory_uri() ?>/images/subpages/reviewer-3.png" alt="user" width="70" height="70" />
                                    </figure>
                                    <blockquote>“ Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Phasellus
                                        hendrerit. Pellentesque aliquet nibh nec urna. In nisi neque ”</blockquote>
                                    <cite>
                    ...
                    <div class="container">
                        ...
                        <div class="row cols-sm-2 cols-md-4">
                            <div class="member appear-animate" data-animation-options="{'name': 'fadeInLeftShorter'}">
                                <figure>
                                    <img src="<?php echo get_template_directory_uri() ?>/images/subpages/team1.jpg" alt="team member" width="280" height="280">
                            ...
                            <div class="member appear-animate"
                                ...
                                <figure>
                                    <img src="<?php echo get_template_directory_uri() ?>/images/subpages/team2.jpg" alt="team member" width="280" height="280">
                                    <div class="overlay social-links">
                                        <a href="#" class="social-link social-facebook fab fa-facebook-f"></a>
                                        <a href="#" class="social-link social-twitter fab fa-twitter"></a>
                                        <a href="#" class="social-link social-linkedin fab fa-linkedin-in"></a>
                            ...
                            <div class="member appear-animate"
                                ...
                                <figure>
                                    <img src="<?php echo get_template_directory_uri() ?>/images/subpages/team3.jpg" alt="team member" width="280" height="280">
                                    <div class="overlay social-links">
                                        <a href="#" class="social-link social-facebook fab fa-facebook-f"></a>
                                        <a href="#" class="social-link social-twitter fab fa-twitter"></a>
                                        <a href="#" class="social-link social-linkedin fab fa-linkedin-in"></a>
                            ...
                            <div class="member appear-animate"
                                ...
                                <figure>
                                    <img src="<?php echo get_template_directory_uri() ?>/images/subpages/team4.jpg" alt="team member" width="280" height="280">
                                    <div class="overlay social-links">
                                        <a href="#" class="social-link social-facebook fab fa-facebook-f"></a>
                                        <a href="#" class="social-link social-twitter fab fa-twitter"></a>
                                        <a href="#" class="social-link social-linkedin fab fa-linkedin-in"></a>
                ...
                <section class="clients-section grey-section pt-10 pb-10">
                    <div class="container">
                        ...
                        <div class="owl-carousel owl-theme row brand-carousel cols-xl-6 cols-lg-5 cols-md-4 cols-sm-3 cols-2 gutter-no pt-1"
                            ...
                            <figure><img src="<?php echo get_template_directory_uri() ?>/images/brands/1.png" alt="brand" width="180" height="100" /></figure>
                            <figure><img src="<?php echo get_template_directory_uri() ?>/images/brands/2.png" alt="brand" width="180" height="100" /></figure>
                            <figure><img src="<?php echo get_template_directory_uri() ?>/images/brands/3.png" alt="brand" width="180" height="100" /></figure>
                            <figure><img src="<?php echo get_template_directory_uri() ?>/images/brands/4.png" alt="brand" width="180" height="100" /></figure>
                            <figure><img src="<?php echo get_template_directory_uri() ?>/images/brands/5.png" alt="brand" width="180" height="100" /></figure>
                            <figure><img src="<?php echo get_template_directory_uri() ?>/images/brands/6.png" alt="brand" width="180" height="100" /></figure>
                        </div>
                    </div>
                </section>
                <!-- End Clients Section -->
