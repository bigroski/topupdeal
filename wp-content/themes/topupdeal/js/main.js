...
$('.wp_autosearch_input').attr('placeholder', 'Search for you product here...');
$('#login-popper').magnificPopup({
    items: {
        src: '#login-popup', // CSS selector of an element on page that should be used as a popup
        type: 'inline'
      },
...
var $grid = $('#products-grid-alternate.grid').isotope({
        ...
        $.ajax({ // you can also use $.post here
            ...
            success : function( data ){
                if( data ) { 
                    ...
                    if ( current_page == button.data('max_pages') ) 
    ...
    Donald.zoomImage = function (selector) {
        if ($.fn.elevateZoom && selector) {
            Donald.$(selector).find('img').each(function () {
                ...
                console.log(Donald.defaults.zoomImage);
