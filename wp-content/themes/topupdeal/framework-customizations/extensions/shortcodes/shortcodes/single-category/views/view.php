...
<h2 class="title title-simple with-link">
    <span class="d-flex align-items-center">
        <span class="mr-4 mt-1 mb-1"><?php echo $atts['block_title']; ?></span>
        <!-- <span
...
</span><a href="<?php echo $atts['main_category_link'] ?>">View more<i class="fas fa-chevron-right"></i></a>
</h2>
<div class="product-grid">
    <div class="grid grid-float row gutter-no">
        <?php 
            foreach($atts['main_sale'] as $ms):
        ?>
        ...
        <?php 
            ...
            if(count($atts['product_on_sales']) > 0):
                foreach($atts['product_on_sales'] as $onSales):
        ?>
            <div class="grid-item col-lg-2 col-sm-6 height-x2">
                <div class="product text-center">
                    <figure class="product-media">
